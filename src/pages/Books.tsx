...
//             >
//               <option value="">All</option>
//               {/* Render publication date options based on selected genre */}
//               {/* Replace 'data.data' with the actual API response data variable */}
//               {data?.data
...
//           {data?.data
//             ?.filter((book: IBook) => {
//               if (book.genre && book.genre.includes(genre)) {
//                 return true;
//               }
//               if (
//                 book.publicationDate &&
